...
using TouchTracking = Curc.Effects;
using native = Curc.Droid.Effects;
using System.Linq;
using Curc.Enumerations;

[assembly: ResolutionGroupName("Effects")]
[assembly: ExportEffect(typeof(native.TouchEffect), nameof(native.TouchEffect))]
namespace Curc.Droid.Effects
{
    public class TouchEffect : PlatformEffect
    {
        ...
        void FireEvent(TouchEffect touchEffect, int id, TouchActionType actionType, Point pointerLocation, bool isInContact)
        {
            ...
            Action<Element, TouchTracking.TouchActionEventArgs> onTouchAction = touchEffect.libTouchEffect.OnTouchAction;
            ...
            onTouchAction(touchEffect.formsElement,
                new TouchTracking.TouchActionEventArgs(id, actionType, point, isInContact));
        }
    }
}